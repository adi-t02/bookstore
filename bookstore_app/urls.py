...
urlpatterns = [
    ...
    path('customer_profile/<int:id>',customer_views.customer_profile,name="customer_profile"),
    ...
    path('seller_profile/<int:id>',seller_views.seller_profile,name="seller_profile"),
